      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1" className="border-b border-deep-charcoal/20">
          ...
          <AccordionContent className="text-base md:text-lg font-poppins text-deep-charcoal/80 pt-2 pb-6 leading-relaxed">
            Yes! Gentlee is free forever with the Gentle Start plan, which gives you 3 messages per week and memory retention for 14 days. Your message count resets every Sunday at 12 AM so you can start fresh.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-3" className="border-b border-deep-charcoal/20">
          ...
          <AccordionContent className="text-base md:text-lg font-poppins text-deep-charcoal/80 pt-2 pb-6 leading-relaxed">
            <p>We're offering exclusive discounts for our first supporters!</p>
