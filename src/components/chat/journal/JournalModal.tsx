...
import { JournalModalContent } from './JournalModalContent';
import { JournalModalActions } from './JournalModalActions';
...
export const JournalModal: React.FC<JournalModalProps> = ({
  ...
  // Update journal text when initialText changes
  useEffect(() => {
    if (isOpen) {
  ...
  // X button click handler - ONLY transfers text and closes modal
